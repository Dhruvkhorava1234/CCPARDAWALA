<?php
$pageTitle = "Why Choose Us | CC Pardawala - Saurashtra's Best Curtains Manufacturer";
$pageDescription = "Discover why CC Pardawala is the most trusted brand for custom curtains, motorized blinds, sofa fabrics, wallpapers & mattresses in Gujarat.";
$activePage = 'why_us';
include 'header.php';
?>

<!-- Inner Page Banner (Centered Architectural Luxury) -->
<section class="inner-banner" style="background-image: url('img/whyus.jpg');">
    <div class="container reveal">
        <div class="banner-centered-content">
            <span class="banner-badge">
                <i class="fa-solid fa-gem"></i> The CC Pardawala Advantage
            </span>
            ...
            <div class="banner-breadcrumbs-center">
                ...
                <span class="current-page">Why Us</span>
            </div>
        </div>
    </div>
</section>
...
<section class="whyus-section">
    <div class="container">
        ...
        <div class="whyus-grid">
            ...
            <div class="whyus-card reveal">
                <div class="whyus-card-top">
                    <span class="whyus-number">1</span>
            ...
            <div class="whyus-card reveal reveal-delay-1">
                <div class="whyus-card-top">
                    <span class="whyus-number">2</span>
                    <div class="whyus-icon-box">
            ...
            <div class="whyus-card reveal reveal-delay-2">
                <div class="whyus-card-top">
                    <span class="whyus-number">3</span>
                    <div class="whyus-icon-box">
            ...
            <div class="whyus-card reveal">
                <div class="whyus-card-top">
                    <span class="whyus-number">4</span>
                    <div class="whyus-icon-box">
            ...
            <div class="whyus-card reveal reveal-delay-1">
                <div class="whyus-card-top">
                    <span class="whyus-number">5</span>
                    <div class="whyus-icon-box">
            ...
            <div class="whyus-card reveal reveal-delay-2">
                <div class="whyus-card-top">
                    <span class="whyus-number">6</span>
                    <div class="whyus-icon-box">
        ...
        <!-- Trust Stats Strip -->
        <div class="whyus-trust-strip reveal">
            <div class="whyus-trust-item">
                <span class="whyus-trust-num">24+</span>
                <span class="whyus-trust-label">Years of Craft Heritage</span>
            </div>
            <div class="whyus-trust-item">
            ...
            <div class="whyus-trust-item">
                ...
                <span class="whyus-trust-label">Regional Showrooms</span>
            </div>
            <div class="whyus-trust-item">
                <span class="whyus-trust-num">100%</span>
                <span class="whyus-trust-label">Custom Sizing Guarantee</span>
            </div>
        </div>
